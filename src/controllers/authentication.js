...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, expectedHash, salt, cookie, domain, error_1;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                if (!((_b = user.authentication) === null || _b === void 0 ? void 0 : _b.salt)) {
                    return [2 /*return*/, res.sendStatus(404)];
                }
            ...
            case 2:
                _d.sent();
                cookie = (_c = process.env.EXPRESS_COOKIE) !== null && _c !== void 0 ? _c : "X-AUTH";
...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                existingUser = (_b = (_c.sent())) !== null && _b !== void 0 ? _b : false;
                if (existingUser) {
                    return [2 /*return*/, res.sendStatus(400)];
                }
                salt = (0, helpers_1.random)();
