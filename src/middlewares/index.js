...
var isAuthenticated = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var cookie, sessionToken, existingUser, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                cookie = (_a = process.env.EXPRESS_COOKIE) !== null && _a !== void 0 ? _a : "X-AUTH";
                sessionToken = req.cookies[cookie];
                if (!sessionToken) {
...
var isOwner = function (req, res, next) {
    try {
        ...
        var currentUserId = (0, lodash_1.get)(req, "identity._id");
        if (!currentUserId) {
